...
$pdf->Cell(80);
$pdf->Cell(30,0,utf8_decode(' V E N T A S   D E L  M E S '),.2,0,'C');// Título	
$pdf->Ln(10);


$pdf->Cell(9);
$pdf->Cell(176,7,utf8_decode('Rango de fechas: '.$nuevafecha.' a '.$fecha2),0,1,'R');
...
$sql=$base->prepare('select * from salidas where fecha BETWEEN "'.$nuevafecha.'" AND "'.$fecha2.'"');
$sql->execute();
